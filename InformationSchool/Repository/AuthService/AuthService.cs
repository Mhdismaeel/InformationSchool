...
namespace InformationSchool.Repository.AuthService
{
    public class AuthService: IAuthService
    {
        ...
        public async Task<AuthModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            authModel.ImageProfile = user.ImageProfile;
            return authModel;
        }
        ...
        public async Task<AuthModel> AdminRegisterAsync(AdminRegisterModel model)
        {
            if (await _userManager.FindByEmailAsync(model.Email) is not null)
                return new AuthModel { Message = "Email is already registered!" };
       ...
       public async Task<bool>  ChangePassword(ResetPasswordBinding model)
        {
            var user = await _userManager.FindByEmailAsync(model.Email);
